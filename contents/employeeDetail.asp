...
<%
	...
	'Response.write "test" & request("sentEditId") 
	'Response.Write "</br> test loginUser Id :" &request("sentUserId") 
	'Response.write("</br>You are the Admin")
...
If Request.form("action")="save" Then
	...
	Else
		...
		strSql = strSql & "WHERE fldEmpId='" &editId& "' or fldEmpId='" &userId& "' "
		...
		strSql = StrSql & " WHERE fk_fldEmpId='" &editId& "' OR fk_fldEmpId='" &userId& "' "
